// AlatiphA Report Cards — app-25.js
...
/* ---------- view switching ---------- */
const views = ['home', 'setup', 'classes', 'students', 'subjects', 'grades', 'remarks', 'reports', 'history'];
...
function sectionTitle(name) {
  const titles = {
    setup: 'Setup', classes: 'Classes', students: 'Students', subjects: 'Subjects',
...
function renderHome() {
  ...
  document.getElementById('statsSummary').innerHTML =
    `<span>TOTAL STUDENTS: ${totalStudents}</span><span class="stats-dot">•</span><span>CLASSES: ${totalClasses}</span>`;
